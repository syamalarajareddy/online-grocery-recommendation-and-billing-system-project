...
# A PROJECT BY :- 1. ANANYA ROY
#                 2. Vemparala Lakshmi Sirisha
#                 3. Syamala Rajareddy
...
def time():     #function to display date and time
    ...
    for i in dateV:
        ...
        DT+='/'
    DT=DT[:len(DT)-1]
    date=tk.Label(root,bg='midnight blue',fg='ghost white',text='Date:  '+DT+'\t\tTime:  '+str(q),bd=3)
...
def addItem():      #add extra item to the bill
    ...
    SNo=tk.Label(root,bg='midnight blue',fg='ghost white',text=str(num))
    ...
    Total=tk.Label(root,bg='midnight blue',text="Total Amount:"+str(sum(totalAmount)),fg='ghost white')
...
#customer Details
nameL=tk.Label(root,bg='midnight blue',fg='ghost white',text='Name')
nameL.grid(column=2,row=4)
nameE=AutocompleteEntry(lista,root)
nameE.grid(column=40,row=4)
NumberL=tk.Label(root,bg='midnight blue',fg='ghost white',text='Mobile Number  ')
...
SNO=tk.Label(root,bg='midnight blue',fg='ghost white',text='SNo.')
SNO.grid(column=40,row=7)
product=tk.Label(root,bg='midnight blue',fg='ghost white',text='Product')
product.grid(column=40,row=7)
price=tk.Label(root,bg='midnight blue',fg='ghost white',text='Price')
price.grid(column=80,row=7)
quantity=tk.Label(root,bg='midnight blue',fg='ghost white',text='Quantity')
quantity.grid(column=120,row=7)
amount=tk.Label(root,bg='midnight blue',fg='ghost white',text='Amount')
...
PrintButton=tk.Button(root,text='Print Bill',font=('Tahoma'),width=20,command=print_bill,bg='green2',fg='Black',bd=5)
PrintButton.grid(column=200,row=34)

SubmitButton=tk.Button(root,text='Recommend',font=('Tahoma'),width=20,command=recommend,bg='light cyan',fg='Black',bd=5)
